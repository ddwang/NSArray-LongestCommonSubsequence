...
-(NSIndexSet *) indexesOfCommonElementsWithArray:(NSArray *) array
									addedIndexes:(NSIndexSet *__autoreleasing *) addedIndexes
								  removedIndexes:(NSIndexSet *__autoreleasing *) removedIndexes
									movedIndexes:(NSMutableDictionary *__autoreleasing *) movedIndexes
{
	NSInteger lengths[self.count+1][array.count+1];
	...
	if (movedIndexes)
	{
		NSArray* cA = [self subarrayWithIndexes:commonIndexes];
	}
